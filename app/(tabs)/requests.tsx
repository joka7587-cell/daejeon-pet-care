...
const STATUS_LABELS: Record<RequestStatus, { label: string; color: string; bg: string }> = {
  ...
  completed: { label: "완료", color: "#8E8E93", bg: "#F8F8F8" },
...
const styles = StyleSheet.create({
  ...
  requestCount: { fontSize: 12, color: "#2E7D32", fontWeight: "600", marginTop: 2 },
  newRequestBtn: {
  ...
  myRequestTagText: { fontSize: 11, color: "#2E7D32", fontWeight: "700" },
  typeTag: {
  ...
  typeTagText: { fontSize: 11, color: "#8E8E93", fontWeight: "600" },
  statusTag: {
    borderRadius: 8,
    paddingHorizontal: 8,
    paddingVertical: 3,
  ...
  cardMeta: { fontSize: 12, color: "#8E8E93", marginBottom: 6 },
  cardFooter: { flexDirection: "row", gap: 12 },
  cardDetail: { fontSize: 12, color: "#8E8E93" },
  emptyCard: {
    alignItems: "center",
    padding: 48,
    gap: 8,
