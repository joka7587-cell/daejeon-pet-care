    ...
    <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 32 }}>
      ...
      <View style={s.section}>
        ...
        <RecommendedSpotCard
          ...
          onPress={() => {
            haptic();
            router.push({ pathname: "/walk/trail-detail", params: { spotId: todaySpot.id, lat: String(todaySpot.latitude), lng: String(todaySpot.longitude) } } as never);
          }}
        />
            ...
            {districtSpots
              ...
              .map((sp) => (
                <Pressable
                  ...
                  onPress={() => {
                    haptic();
                    router.push({ pathname: "/walk/trail-detail", params: { spotId: sp.id, lat: String(sp.latitude), lng: String(sp.longitude) } } as never);
                  }}
