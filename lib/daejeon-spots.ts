 ...
 *
 * Phase 60 수정사항:
 * - 남선공원: 서구 탄방동으로 정정 (중구 아님)
 * - 동춘당공원: 대덕구 송촌동 확인 (위키 좌표 36.3654, 127.4413)
 * - 한밭수목원: 공공데이터 좌표 36.3665, 127.3880 (서구 만년동/둔산동)
 * - 사용자 지정 입구 좌표 4곳 반영
 * - ID 중복 해결 (spot_3, spot_4 분리)
 */
...
export const DAEJEON_WALK_SPOTS: WalkSpot[] = [
  ...
  },
  {
    ...
    district: "서구",
    dong: "탄방동",
    description: "대전 서구 탄방동에 위치한 약 15만㎡ 규모의 도심 속 생태공원. 산책로와 체육시설이 잘 갖춰져 있습니다.",
    emoji: "🌿",
    features: ["산책로", "체육관", "생태숲", "주차장"],
    latitude: 36.345,
    longitude: 127.402,
    ...
    walkTime: "20~30분",
    difficulty: "쉬움",
    petFriendly: "소형견 산책에 적합, 데크길 이용 가능",
  },
  {
    id: "spot_4",
    name: "유림공원",
    district: "유성구",
    dong: "봉명동",
    description: "대전 유성구 봉명동의 대표 문화공원. 호수 주변 산책로와 운동시설이 잘 갖춰져 있습니다.",
    emoji: "🏞️",
  ...
  },
  {
    ...
    district: "대덕구",
    dong: "송촌동",
    description: "조선시대 보물 동춘당이 있는 역사 공원. 조용하고 아늑한 분위기입니다.",
    emoji: "🏛️",
