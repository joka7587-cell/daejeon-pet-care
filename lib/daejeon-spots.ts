...
export const DAEJEON_WALK_SPOTS: WalkSpot[] = [
  ...
  },
  {
    ...
    district: "서구",
    dong: "괴정동",
    description: "대전 서구의 대표 공원. 호수 주변 산책로와 운동시설이 잘 갖춰져 있습니다.",
    emoji: "🏞️",
  ...
  },
  {
    ...
    district: "서구",
    dong: "월평동",
    description: "갑천변을 따라 이어지는 긴 산책로. 자전거도로와 분리되어 안전합니다.",
    emoji: "🌊",
    features: ["하천 산책로", "자전거도로", "벤치", "야간 조명"],
    latitude: 36.3558,
    longitude: 127.3761,
    imageTag: "gapcheon",
    rating: 4.7,
    walkTime: "40~90분",
    difficulty: "보통",
    petFriendly: "긴 산책에 적합, 물놀이 가능 구간 있음",
  },
  {
    id: "spot_6",
    name: "대전 오월드 인근 산책로",
