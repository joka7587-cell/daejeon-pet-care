...
const s = StyleSheet.create({
  ...
  header: {
    ...
    paddingVertical: 14,
    borderBottomWidth: 1,
    borderBottomColor: "#E8ECE0",
    backgroundColor: "#FFFFFF",
  },
  title: { fontFamily: Fonts.bold, fontSize: 18, color: "#2E7D32", letterSpacing: -0.3 },
  statusDot: { width: 10, height: 10, borderRadius: 5 },
  statusText: { fontSize: 13, fontWeight: "600", color: "#2E7D32" },
  districtText: { fontSize: 12, color: "#2E7D32", marginLeft: 4, fontWeight: "500" },
  closeBtn: {
  ...
  closeBtnText: { fontFamily: Fonts.semiBold, fontSize: 13, color: "#666666" },
  mapContainer: {
    marginHorizontal: 16,
    marginTop: 12,
  ...
  loadingText: { fontSize: 13, color: "#2E7D32", fontWeight: "500" },
  errorContainer: {
    flex: 1,
    alignItems: "center",
    justifyContent: "center",
  ...
  errorText: { fontSize: 14, fontWeight: "700", color: "#FF3B30", textAlign: "center", letterSpacing: -0.2 },
  errorSub: { fontSize: 12, color: "#8E8E93", textAlign: "center", lineHeight: 18, letterSpacing: -0.1 },
  mapBadge: {
    position: "absolute",
    top: 14,
    left: 14,
  ...
  mapBadgeText: { fontSize: 12, color: "#FFFFFF", fontWeight: "700", letterSpacing: -0.2 },
  infoCard: {
    marginHorizontal: 16,
    marginTop: 12,
    backgroundColor: "#F8FBF5",
  ...
  infoName: { fontFamily: Fonts.bold, fontSize: 15, color: "#2E7D32" },
  infoSub: { fontFamily: Fonts.regular, fontSize: 12, color: "#8E8E93", marginTop: 2, letterSpacing: -0.1 },
  statsRow: {
    flexDirection: "row",
    marginHorizontal: 16,
    marginTop: 12,
  ...
  statValue: { fontFamily: Fonts.bold, fontSize: 14, color: "#2E7D32" },
  statLabel: { fontFamily: Fonts.regular, fontSize: 11, color: "#8E8E93", fontWeight: "500" },
  statDivider: { width: 1, height: 40, backgroundColor: "#2E7D32", opacity: 0.2 },
  endWalkBtn: {
    marginHorizontal: 16,
    marginTop: 16,
  ...
  endWalkBtnText: { fontFamily: Fonts.bold, fontSize: 16, color: "#FFFFFF", letterSpacing: -0.3 },
  completedBanner: {
    marginHorizontal: 16,
    marginTop: 16,
    backgroundColor: "#E8F5E9",
  ...
  completedText: { fontFamily: Fonts.bold, fontSize: 15, color: "#2E7D32", letterSpacing: -0.2 },
});
